...
label s3x3(firsttime):
    ...
    rando "Isn't the Hagia Sophia so beautiful?"
    menu:
        "Yes, indeed":
            pause 0.001
        "Meh":
            rando "Well what about the Blue Mosque?"
    ...
    rando "What do ya think about this one?"
    menu:
        "It's amazing":
            pause 0.001
        "I'm not really sold on it":
            rando "Okay, mister opinions."
    rando "Look, the parade is starting!"
